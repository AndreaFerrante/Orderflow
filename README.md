...
<br> This module uses [Numpy](https://numpy.org/), [Pandas](https://pandas.pydata.org/) and [Polars](https://pola.rs/) for <b>amazing</b> speed in managing the data and it is PEP-8 compliant by using black https://github.com/psf/black.
